...
const CartScreen = ({ navigation, route }: TabsStackScreenProps<"Cart">) => {
    ...
    const deleteItem = (item: ProductListParams) => {
        dispatch(removeFromCart(item)); // Chỉ truyền ID của sản phẩm
...
// import React, { useEffect, useState } from "react";
// import {View,Text,SafeAreaView,ScrollView,Platform,Pressable,Alert,Dimensions,ImageBackground,Image,} from "react-native";
// import { RootStackScreenProps } from "../Navigation/RootNavigator";
// import {AntDesign, MaterialCommunityIcons,Ionicons,Feather,} from "@expo/vector-icons";
// import { useDispatch, useSelector } from "react-redux";
// import {addToCart,decreaseQuantity,increaseQuantity,removeFromCart,} from "../redux/CartReducer";
// import { TabsStackScreenProps } from "../Navigation/TabsNavigation";
// import { CartState, ProductListParams } from "../TypesCheck/productCartTypes";
// import DisplayMessage from "../Components/DisplayMessage";
// import { HeadersComponent } from "../Components/HeaderComponents/HeadersComponent";
...
// // const CartScreen: React.FC<TabsStackScreenProps<"Cart">> = ({ navigation, route }) => {
...
//             //         // screenTitle: "Checkout Details",screenTitle: "Chi tiết thanh toán",cartItems: cart, notesState: notes,});
//             // }
//         }
//     };
//     const increaceQuantity = (item: ProductListParams) => {
...
//                 <View style={{ backgroundColor: "#eee", borderColor: "#fff", alignContent: "center" }}>
//                     <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
//                         <Text style={{ marginLeft: 10, fontSize: 28, fontWeight: "400", color: "blue" }}>Tổng tiền:</Text>
//                         <Text style={{ fontSize: 28, fontWeight: "bold", color: "blue" }}>
//                             {total.toLocaleString("vi-VN")}$
//                         </Text>
//                     </View>
...
//                         }}
//                     >
//                         <Text style={{ fontSize: 28, fontWeight: "bold", color: "purple" }}>Mua hàng ({cart.length})</Text>
//                     </Pressable>
//                 </View>
//             </ScrollView >
//         </SafeAreaView >
